...
class ProductoController extends Controller
{
    ...
    {
        // Redirigir al index ya que el formulario está ahí
    ...
    public function show(Producto $producto)
    {
        ...
        // Si la petición es AJAX (para el modal de editar), devolver JSON
        if (request()->wantsJson()) {
            return response()->json($producto);
        }
        
        // Si no es AJAX, mostrar la vista de detalle normal
